...
//admin process =======================================================================
     Route::prefix('admin')->group(function (){
        ...
        Route::get('login', [AdminAuthSessionController::class, 'create'])
        ->name('admin.login');
...
Route::prefix('admin')->group(function (){
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::post('logout', [AdminAuthSessionController::class, 'destroy'])
        ->name('admin.logout');



        //only autheticated user can register a new user
