@extends('layouts.app')
@section('slider')
@include('Miscelaneous.ActuOnt.art004.slider')
@endsection
@section ('content')
                            ...
                            <div class="article-top__image">
                                ...
                                <div class="article__text">
                                   ...
                                   <div class="article__text-text">
                                    <p>Six jours après avoir été présenté à l’ensemble des cadres et agents du secteur du tourisme, le nouveau ministre du tourisme Modero NSIMBA MATONDO a, cette fois, été présenté aux agents et cadres de l’Office National du Tourisme. Cette cérémonie de présentation s’est déroulée le 12 mai 2021, au siège social de l’ONT.</p>
                                    <p>C’est le Directeur Général ai de l’ONT, Madame YOMBO MUKENDI Jolie qui a reçu le ministre Modero NSIMBA MATONDO dans les installations de cet office. Elle s’est ensuite chargée de la présenter auprès des agents et cadres de cet établissement public réunis pour la circonstance.</p>
                                    <p>Dans la foulée de cette cérémonie de présentation, le ministre Modero NSIMBA s’est imprégné des conditions de travail des cadres et agents de l’ONT. Il en a profité pour recevoir les desideratas de la délégation syndicale des travailleurs de l’Office. En réponse à leurs revendications, le Ministre national du tourisme a d’abord compati à leur situation. Il a promis que la tutelle fera de son mieux pour mettre l’homme au centre du travail. Sous son mandat, il va lutter pour l’amélioration des conditions sociales et professionnelles du personnel de l’Office National du Tourisme.
                                 </p>
                                   </div>
                                </div>
                            </div>
