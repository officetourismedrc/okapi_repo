<section class="map__interactive section">
    <div class="map__interactive_container container">
     <div class="map__description">
        <div class="map-desc__container">
             <div class="map-desc__group map-desc-Active" id="list-BC">
                  <div class="map-desc__images">
                    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/group1_inga_dam.jpg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group1-baoba.jpeg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/group1_inga_dam.webp')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-4"><img src="{{url('assets/images/map_image/group1_vampa.webp')}}" class="map-desc__img" alt=""></div>
                  </div>
                  <div class="map-desc__description">
                    <h2 class="map-desc__title">Kongo Central</h2>
                    <div class="map-desc__drescription-contenu">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
                    </div>
                  </div>
             </div>

             <div class="map-desc__group" id="list-BU">
              <div class="map-desc__images">
                 <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe-flore2.jpg')}}" alt="" class="map-desc__img"></div>
                 <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group2-flore.jpg')}}" alt="" class="map-desc__img"></div>
                 <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-butterfly.webp')}}" alt="" class="map-desc__img"></div>
                 <div class="map-desc__image map-desc__image-4"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
              </div>
              <div class="map-desc__description">
                <h2 class="map-desc__title">Bas-Uélé</h2>
                <div class="map-desc__drescription-contenu">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
                </div>
              </div>
         ...
         <div class="map-desc__group" id="list-ET">
          <div class="map-desc__images">
             <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-4"><img src="{{url('assets/images/map_image/groupe-flore2.jpg')}}" alt="" class="map-desc__img"></div>
          </div>
          <div class="map-desc__description">
            <h2 class="map-desc__title">Équateur</h2>
            <div class="map-desc__drescription-contenu">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
            </div>
          </div>
     ...
     <div class="map-desc__group" id="list-HK">
      <div class="map-desc__images">
        <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/group1_inga_dam.jpg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group1-baoba.jpeg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/group1_inga_dam.webp')}}" class="map-desc__img" alt=""></div>
      ...
      <div class="map-desc__description">
        <h2 class="map-desc__title">Haut-Katanga</h2>
        <div class="map-desc__drescription-contenu">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
        </div>
      </div>
 ...
 <div class="map-desc__group" id="list-HL">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Haut-Lomami</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-HU">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/group1_inga_dam.jpg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group1-baoba.jpeg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/group1_inga_dam.webp')}}" class="map-desc__img" alt=""></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Haut-Uélé</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-IT">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Ituri</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-KG">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/group1_inga_dam.jpg')}}" class="map-desc__img" alt=""></div>
    <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group1-baoba.jpeg')}}" class="map-desc__img" alt=""></div>
    <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/group1_inga_dam.webp')}}" class="map-desc__img" alt=""></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Kwango</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-KN">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Kinshasa</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-KO">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/group1_inga_dam.jpg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group1-baoba.jpeg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/group1_inga_dam.webp')}}" class="map-desc__img" alt=""></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Kasaï Oriental</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-KS">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Kasaï</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-KU">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="assets/images/map_image/group1_inga_dam.jpg" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-2"><img src="assets/images/map_image/group1-baoba.jpeg" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-3"><img src="assets/images/map_image/group1_inga_dam.webp" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-4"><img src="assets/images/map_image/group1_vampa.webp" class="map-desc__img" alt=""></div>
  </div>
  <div class="map-desc__description">
    <h2 class="map-desc__title">Kwilu</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-LB">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Lualaba</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-KC">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/group1_inga_dam.jpg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group1-baoba.jpeg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/group1_inga_dam.webp')}}" class="map-desc__img" alt=""></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Kasaï-Central</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-LM">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
    <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
    <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Lomami</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-MA">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/group1_inga_dam.jpg')}}" class="map-desc__img" alt=""></div>
    <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group1-baoba.jpeg')}}" class="map-desc__img" alt=""></div>
    <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/group1_inga_dam.webp')}}" class="map-desc__img" alt=""></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Mai-Ndombe</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-MN">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Maniema</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-MO">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Mongala</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-NK">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/group1_inga_dam.jpg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group1-baoba.jpeg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/group1_inga_dam.webp')}}" class="map-desc__img" alt=""></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Nord-Kivu</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-NU">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Nord-Ubangi</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-SK">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/group1_inga_dam.jpg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group1-baoba.jpeg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/group1_inga_dam.webp')}}" class="map-desc__img" alt=""></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Sud-Kivu</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-SN">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
    <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
    <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Sankuru</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-SU">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
             <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Sud-Ubangi</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-TG">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/group1_inga_dam.jpg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group1-baoba.jpeg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/group1_inga_dam.webp')}}" class="map-desc__img" alt=""></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Tanganyika</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-TO">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/groupe3-flore3.avif')}}" alt="" class="map-desc__img"></div>
    <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/groupe3-plant.jpg')}}" alt="" class="map-desc__img"></div>
    <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/groupe2-pinkFlore.webp')}}" alt="" class="map-desc__img"></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Tshopo</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
...
<div class="map-desc__group" id="list-TP">
  <div class="map-desc__images">
    <div class="map-desc__image map-desc__image-1"><img src="{{url('assets/images/map_image/group1_inga_dam.jpg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-2"><img src="{{url('assets/images/map_image/group1-baoba.jpeg')}}" class="map-desc__img" alt=""></div>
                     <div class="map-desc__image map-desc__image-3"><img src="{{url('assets/images/map_image/group1_inga_dam.webp')}}" class="map-desc__img" alt=""></div>
  ...
  <div class="map-desc__description">
    <h2 class="map-desc__title">Tshuapa</h2>
    <div class="map-desc__drescription-contenu">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque voluptatem delectus similique quas saepe ut,</p>
    </div>
  </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:amcharts="http://amcharts.com/ammap" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 800 740">
      ...
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined" id="svg_2" y2="583.66667" x2="673.88166" y1="583.66667" x1="593.88166" stroke="#000" fill="none"></line>
      <text xmlns="http://www.w3.org/2000/svg" class="HK" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_4" y="590.66667" x="680.88166" stroke-width="0" stroke="#000" fill="#000000">HAUT KATANGA</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" id="svg_5" y2="605" x2="416.88166" y1="606" x1="351.88166"
        stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class="LB" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_6" y="610" x="430.88166" stroke-width="0" stroke="#000" fill="#FF0000">LUALABA</text>

      <line xmlns="http://www.w3.org/2000/svg" id="svg_57" y2="650" x2="280.88166" y1="440" x1="423.88166" stroke="#000" fill="none"></line>
      <text xmlns="http://www.w3.org/2000/svg" class="KO" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_10" y="670" x="240.88166" stroke-width="0" stroke="#000" fill="#000000">KASAI-ORIENTAL</text>

      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined" id="svg_3" y2="670.33333" x2="200.88166" y1="446.33333" x1="375.88166" stroke="#000" fill="none"></line>
      <text xmlns="http://www.w3.org/2000/svg" class="LL" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_11" y="690.33333" x="140.88166" stroke-width="0" stroke="#000" fill="#000000">KASAI-CENTRAL</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_13" y2="438" x2="672.88166" y1="449" x1="553.88166" stroke="#000" fill="none" />  -->
      <text xmlns="http://www.w3.org/2000/svg" class="TG" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_14" y="470" x="540.88166" stroke-width="0" stroke="#000" fill="#000000">TANGANYIKA</text>


      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined" id="svg_15" y2="324" x2="680.88166" y1="324.5" x1="599.88166" stroke="#000" fill="none"></line>
      <text xmlns="http://www.w3.org/2000/svg" class="SK" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_16" y="328" x="700.88166" stroke-width="0" stroke="#000" fill="#000000">SUD-KIVU</text>

      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined" id="svg_17" y2="222" x2="685.88166" y1="222" x1="620.88166" stroke="#000" fill="none"></line>
      <text xmlns="http://www.w3.org/2000/svg" class="NK" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_18" y="225" x="700.88166" stroke-width="0" stroke="#000" fill="#000000">NORD-KIVU</text>
      
      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_19" y2="153" x2="718.88166" y1="142" x1="619.88166" stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class="IT" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_20" y="152" x="623.88166" stroke-width="0" stroke="#000" fill="#000000">ITURI</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_21" y2="97" x2="715.88166" y1="96" x1="608.88166" stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg"  class="HU" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_22" y="88" x="598.88166" stroke-width="0" stroke="#000" fill="#000000">HAUT-UELE</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_23" y2="45" x2="692.88166" y1="56" x1="473.88166" stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class="BU" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_24" y="65" x="460.88166" stroke-width="0" stroke="#000" fill="#000000">BAS-UELE</text>


      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined" id="svg_25" y2="62" x2="209.88166" y1="62" x1="328.88166" stroke="#000" fill="none"></line>
      <text xmlns="http://www.w3.org/2000/svg"  class="NU" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_26" y="67" x="83.88166" stroke-width="0" stroke="#000" fill="#000000">NORD-UBANGI</text>


      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined" id="svg_27" y2="100" x2="208.88166" y1="100" x1="272.88166" stroke="#000" fill="none"></line>
      <text xmlns="http://www.w3.org/2000/svg" class="SU" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_28" y="105" x="95.88166" stroke-width="0" stroke="#000" fill="#000000">SUD-UBANGI</text>


      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined" id="svg_29" y2="132" x2="208.88166" y1="132" x1="333.88166" stroke="#000" fill="none"></line>
      <text xmlns="http://www.w3.org/2000/svg" class="MO" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_30" y="136" x="113.88166" stroke-width="0" stroke="#000" fill="#000000">MONGALA</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_31" y2="176" x2="168.88166" y1="176" x1="263.88166" stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class="ET" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_32" y="195" x="225.88166" stroke-width="0" stroke="#000" fill="#000000">EQUATEUR</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_33" y2="198" x2="168.88166" y1="154" x1="492.88166" stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class="TO" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_34" y="145" x="460.88166" stroke-width="0" stroke="#000" fill="#000000">TSHOPO</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_35" y2="237" x2="149.88166" y1="226" x1="360.88166" stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class="TP" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_36" y="215" x="330.88166" stroke-width="0" stroke="#000" fill="#000000">TSHUAPA</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_37" y2="322" x2="129.88166" y1="325" x1="236.88166" stroke="#000" fill="none" />  -->
      <text xmlns="http://www.w3.org/2000/svg" class="MA" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_38" y="317" x="180.88166" stroke-width="0" stroke="#000" fill="#000000">MAI-NDOMBE</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_39" y2="278" x2="133.88166" y1="325" x1="428.88166" stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class="SN" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_40" y="318" x="400.88166" stroke-width="0" stroke="#000" fill="#000000">SANKURU</text>

      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined" id="svg_41" y2="457" x2="91.88166" y1="416" x1="91.88166" stroke="#000" fill="none"></line>
      <text xmlns="http://www.w3.org/2000/svg" class="BC" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_42" y="472" x="13.88166" stroke-width="0" stroke="#000" fill="#000000">KONGO-CENTRAL</text>


      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined" id="svg_43" y2="335" x2="140.88166" y1="373" x1="140.88166" stroke="#000" fill="none"></line>
      <text xmlns="http://www.w3.org/2000/svg" class="KN" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_44" y="342" x="17.88166" stroke-width="0" stroke="#000" fill="#FF0000">KINSHASA</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_45" y2="516" x2="141.88166" y1="462" x1="215.88166" stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class="KG" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_46" y="480" x="189.88166" stroke-width="0" stroke="#000" fill="#000000">KWANGO</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_47" y2="600" x2="159.88166" y1="404" x1="252.88166" stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class="KU" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_48" y="390" x="230.88166" stroke-width="0" stroke="#000" fill="#000000">KWILU</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" stroke-linecap="undefined" stroke-linejoin="undefined"
        id="svg_49" y2="700" x2="473.88166" y1="514" x1="479.88166" stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class="HL" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_50" y="534" x="446.88166" stroke-width="0" stroke="#000" fill="#000000">HAUT-LOMAMI</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" id="svg_51" y2="369" x2="670.88166" y1="362" x1="516.88166"
        stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class="MN" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" id="svg_52" y="352" x="490.88166" stroke-width="0" stroke="#000" fill="#000000">MANIEMA</text>


      <line xmlns="http://www.w3.org/2000/svg"  stroke="#000" id="svg_53" y2="423" x2="685.88166" y1="423" x1="471.88166" fill="none"></line>
      <text xmlns="http://www.w3.org/2000/svg" class="LM" xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" stroke-width="0" id="svg_54" y="428.99" x="700.88166" stroke="#000" fill="#000000">LOMAMI</text>

      <!--
      <line xmlns="http://www.w3.org/2000/svg" id="svg_55" y2="637" x2="205.88166" y1="401" x1="321.88166"
        stroke="#000" fill="none" /> -->
      <text xmlns="http://www.w3.org/2000/svg" class='KS' xml:space="preserve" text-anchor="start" font-family="Montserrat,sans-serif" font-size="15" font-weight="bold" stroke-width="0" id="svg_56" y="388" x="310.88166" stroke="#000" fill="#000000">KASAI</text>

      <ellipse xmlns="http://www.w3.org/2000/svg" ry="3.5" rx="3.5" id="svg_58" cy="583.5" cx="589.38166" stroke="#000" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 480.382 524.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_61" cy="506.5" cx="460.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 420.382 604.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_62" cy="604.5" cx="420.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 548.382 448.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_63" cy="420.5" cx="507.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 466.382 428.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_64" cy="433.5" cx="466.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 513.382 360.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_65" cy="360.5" cx="500.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 585.382 324.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_66" cy="324.5" cx="575.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 607.382 224.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_67" cy="226.5" cx="590.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 615.382 143.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_68" cy="127.5" cx="588.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 603.382 95.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_69" cy="95.5" cx="565.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 470.382 57.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_70" cy="40" cx="440.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 493.382 151.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_71" cy="151.5" cx="493.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 430.382 326.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_72" cy="326.5" cx="430.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 330.382 59.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_73" cy="57.5" cx="330.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 277.382 102.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_74" cy="105.5" cx="277.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 337.382 128.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_75" cy="125.5" cx="337.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 266.382 173.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_76" cy="143.5" cx="266.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 362.382 224.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_77" cy="224.5" cx="362.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 239.382 324.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_78" cy="324.5" cx="239.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 141.382 374.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_79" cy="374.5" cx="141.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 92.382 413.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_80" cy="413.5" cx="92.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 216.382 458.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_81" cy="458.5" cx="216.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 254.382 401.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_82" cy="401.5" cx="254.38166" fill="#EEF0F0"></ellipse>

      <ellipse xmlns="http://www.w3.org/2000/svg" transform="rotate(-178.472 325.382 396.5)" stroke="#000" ry="3.5" rx="3.5" id="svg_83" cy="396.5" cx="325.38166" fill="#EEF0F0"></ellipse>
